...
const selfCompassionTools = [
  ...
  },
  {
    ...
    categoryId: "self-compassion-practices",
...
const progressiveMuscleRelaxationTools = [
  {
    ...
    title: "Full-Body Relaxation Guide",
    description:
      "A comprehensive guide to relaxing all major muscle groups for stress relief and calmness.",
    href: "/tools/full-body-relaxation-guide",
  },
  {
    id: "pmr-tool-2",
    categoryId: "progressive-muscle-relaxation-guides",
    title: "Quick PMR Routine",
    description:
      "A short, 5-minute PMR routine for quick relaxation during busy days.",
  ...
  },
  {
    ...
    title: "PMR Guide",
    description:
      "A guide to practicing progressive muscle relaxation to release physical tension and promote calmness.",
    href: "/tools/progressive-muscle-relaxation-guide",
  },
  {
    id: "pmr-tool-4",
    categoryId: "progressive-muscle-relaxation-guides",
    title: "PMR for Tension Headaches",
    description:
...
const communicationTools = [
  ...
  },
  {
    ...
    categoryId: "relationship-toolkit",
