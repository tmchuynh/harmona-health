...
export const hospitality: ToolLinks[] = [
  {
    title: "Cloudbeds",
    description:
      "A hotel management software that allows hoteliers to manage reservations, front desk, billing, and guest experience all in one platform.",
  ...
  },
  {
    title: "Revinate",
    description:
      "A hospitality marketing platform offering tools for email campaigns, guest data analytics, and customer engagement.",
  ...
  },
  {
    title: "RoomRaccoon",
    description:
      "A fully automated hotel management system, including booking, check-in/check-out, invoicing, and guest messaging.",
  ...
  },
  {
    title: "Hotelogix",
    description:
      "A cloud-based hotel management software designed to streamline operations for small to mid-sized properties, including reservations and front desk management.",
  ...
  },
  {
    title: "Guestline",
    description:
      "A cloud-based property management system (PMS) that helps hotels with reservations, billing, and guest management.",
  ...
  },
  {
    title: "Simpleview",
    description:
      "A platform designed for destination marketing organizations (DMOs) to promote and manage travel destinations.",
  ...
  },
  {
    title: "Kipsu",
    description:
      "A real-time customer service platform that allows hospitality businesses to engage with guests through live chat and feedback systems.",
  ...
  },
  {
    title: "Tripleseat",
    description:
      "An event management software designed for restaurants, venues, and event spaces, streamlining booking, lead generation, and client communication.",
