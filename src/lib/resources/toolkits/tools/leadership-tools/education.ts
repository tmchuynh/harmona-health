...
export const education: ToolLinks[] = [
  ...
  },
  {
    title: "Tynker",
    description:
      "A creative coding platform that teaches kids programming through interactive games, stories, and real-world problem-solving.",
  ...
  },
  {
    title: "Storybird",
    description:
      "An innovative storytelling tool where students create art-inspired stories, enhancing writing skills and creativity.",
  ...
  },
  {
    title: "Edmodo",
    description:
      "A learning management system that facilitates communication between students, teachers, and parents while managing assignments and grades.",
  ...
  },
  {
    title: "Zoom",
    description:
      "A video conferencing tool widely used for online classes, meetings, and collaboration in educational settings.",
    href: "https://zoom.us",
    image:
  ...
  },
  {
    title: "Quizlet",
    description:
      "An online learning tool that provides flashcards and practice tests to help students study for exams and improve their knowledge.",
  ...
  },
  {
    title: "Schoology",
    description:
      "An LMS platform that connects students, teachers, and parents to facilitate a seamless learning experience.",
  ...
  },
  {
    title: "Seesaw",
    description:
      "A digital portfolio and communication tool that allows students to document their learning and share it with their teachers and parents.",
