...
export const communicationInLeadership: CommunicationTools[] = [
  {
    ...
    description:
      "Leaders must clearly articulate the vision and goals of a team or organization. Effective communication helps align team members, inspire action, and foster a shared sense of purpose.",
    items: {
      item: [
        {
          title: "Communicating Vision",
          description:
            "Articulating a compelling vision sets the foundation for collective motivation and strategic focus.",
          examples: [
        ...
        },
        {
          ...
          description:
            "Clarity around roles, timelines, and deliverables ensures accountability and reduces ambiguity.",
          examples: [
        ...
        },
        {
          ...
          description:
            "Tag relevant team members to loop them in and encourage collaboration.",
          examples: [
        ...
        },
        {
          ...
          description:
            "Leaders must communicate in ways that motivate and connect team members to the bigger picture.",
          examples: [
  ...
  },
  {
    ...
    description:
      "Trust is the foundation of leadership. Consistent, honest, and transparent communication builds credibility and fosters loyalty.",
    items: {
      item: [
        {
          title: "Being Transparent",
          description:
            "Openly sharing information, especially during challenges, builds respect and psychological safety.",
          examples: [
        ...
        },
        {
          ...
          description:
            "Leaders who align words with actions and communicate consistently across contexts build long-term trust.",
          examples: [
        ...
        },
        {
          title: "Using Humor",
          description:
            "Appropriate humor can lighten the mood and foster connection.",
          examples: [
        ...
        },
        {
          ...
          description:
            "Listening to understand and respond with empathy is critical for trust-building in leadership roles.",
          examples: [
      ...
      item: [
        {
          ...
          description:
            "Encourage engagement by ending messages with open-ended questions.",
          examples: [
        ...
        },
        {
          ...
          description:
            "Foster a culture of collaboration by inviting team members to contribute ideas and solutions.",
          examples: [
        ...
        },
        {
          ...
          description:
            "Utilize task management tools to streamline communication and keep everyone on the same page.",
          examples: [
  ...
  },
  {
    ...
    description:
      "Leadership communication isn’t just about directing—it’s also about encouraging others, offering feedback, and creating opportunities for growth.",
    items: {
      item: [
        {
          title: "Providing Constructive Feedback",
          description:
            "Leaders guide performance through thoughtful, timely feedback that focuses on behaviors and outcomes.",
          examples: [
        ...
        },
        {
          ...
          description:
            "Empowering team members means fostering autonomy and helping them develop their strengths through mentorship.",
          examples: [
        ...
        },
        {
          ...
          description:
            "Acknowledging individual and team successes boosts morale and reinforces positive behavior.",
          examples: [
        ...
        },
        {
          ...
          description:
            "Support team members in pursuing growth opportunities, whether through training, conferences, or new projects.",
          examples: [
        ...
        },
        {
          ...
          description:
            "Encourage a culture of learning and resilience by promoting a growth mindset.",
          examples: [
        ...
        },
        {
          ...
          description:
            "Diverse perspectives lead to better decision-making and innovation.",
          examples: [
        ...
        },
        {
          ...
          description:
            "Support team members in maintaining a healthy work-life balance to prevent burnout and promote well-being.",
          examples: [
