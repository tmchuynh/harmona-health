...
export const feedbackThatFuelsGrowth: CommunicationTools[] = [
  {
      ...
      item: [
        {
          ...
          examples: [
            ...
            "Provide actionable next steps after pointing out an issue.",
          ],
        },
        {
          ...
          examples: [
            ...
            "Acknowledge progress while guiding next steps.",
          ],
        },
        {
      ...
      item: [
        {
          ...
          examples: [
            ...
            "Encouraging informal feedback during team huddles.",
          ],
        },
        {
          ...
          examples: [
            ...
            "Encouraging team members to share their feedback experiences.",
          ],
        },
        {
        ...
        },
        {
          ...
          examples: [
            ...
            "Creating a recognition program for feedback champions.",
          ],
        },
        {
          ...
          examples: [
            ...
            "Encouraging team members to practice feedback skills in role-playing scenarios.",
          ],
        },
      ],
    },
      ...
      item: [
        {
          ...
          examples: [
            ...
            "Encouraging others to use the SBI model for clarity.",
          ],
        },
        {
          ...
          examples: [
            ...
            "Encouraging team members to use this approach in peer reviews.",
          ],
        },
        {
          ...
          examples: [
            ...
            "Creating a safe space for open discussions about performance.",
          ],
        },
        {
          ...
          examples: [
            ...
            "Using the results to inform personal development plans.",
          ],
        },
        {
          ...
          examples: [
            ...
            "Encouraging team members to participate in feedback surveys.",
          ],
        },
        {
          ...
          examples: [
            ...
            "Creating a shared document for ongoing feedback and suggestions.",
          ],
        },
        {
          ...
          examples: [
            ...
            "Using role-playing scenarios to practice feedback skills.",
          ],
        },
      ],
    },
      ...
      item: [
        {
          ...
          examples: [
            ...
            "Using feedback to inform performance improvement plans.",
          ],
        },
        {
          ...
          examples: [
            ...
            "Encouraging team members to share their progress in team meetings.",
          ],
        },
        {
          ...
          examples: [
            ...
            "Creating a recognition program to celebrate individual and team achievements.",
          ],
        },
        {
          ...
          examples: [
            ...
            "Using feedback as a tool for ongoing personal and professional growth.",
          ],
        },
        {
          ...
          examples: [
            ...
            "Creating a culture of adaptability and continuous improvement.",
          ],
        },
        {
          ...
          examples: [
            ...
            "Using feedback loops to inform team development initiatives.",
          ],
        },
      ],
    },
      ...
      item: [
        ...
        },
        {
          ...
          examples: [
            ...
            "Creating a safe space for open discussions about team dynamics.",
          ],
        },
        {
        ...
        },
        {
          ...
          examples: [
            ...
            "Using client feedback to inform product development and improvements.",
          ],
        },
        {
          ...
          examples: [
            ...
            "Using customer feedback to inform marketing strategies.",
          ],
        },
      ],
    },
      ...
      item: [
        {
          ...
          examples: [
            ...
            "Using screen sharing to provide visual feedback on work.",
          ],
        },
        {
          ...
          examples: [
            ...
            "Using emojis or GIFs to convey tone in informal settings.",
          ],
        },
        {
        ...
        },
        {
          ...
          examples: [
            ...
            "Creating opportunities for team members to share feedback in a relaxed setting.",
          ],
        },
        {
          ...
          examples: [
            ...
            "Being flexible with deadlines to account for time zone differences.",
          ],
        },
      ],
    },
      ...
      item: [
        {
          ...
          examples: [
            ...
            "Creating a culture of self-reflection and continuous improvement.",
          ],
        },
        {
          ...
          examples: [
            ...
            "Using peer feedback to inform performance reviews.",
          ],
        },
        {
          ...
          examples: [
            ...
            "Creating a culture of learning and development within the team.",
          ],
        },
        {
          title: "Mentorship",
          ...
          examples: [
            ...
            "Using mentorship to foster professional growth and development.",
          ],
        },
        {
          title: "Goal Setting",
          ...
          examples: [
            ...
            "Using goal-setting tools to track progress and achievements.",
          ],
        },
      ],
    },
