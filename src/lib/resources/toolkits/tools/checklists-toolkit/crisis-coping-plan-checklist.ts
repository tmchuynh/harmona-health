export const crisisCopingPlanChecklist: string[] = [
  ...
  "Reflect on what you can learn from this crisis to help you in the future.",
  ...
  "Create a list of positive affirmations or quotes that resonate with you and can be used during crises.",
  "Reflect on your values and how they can guide you through this crisis.",
  "Consider seeking professional help or therapy to develop long-term coping strategies.",
  "Practice self-care by engaging in activities that bring you joy and relaxation.",
  "Identify any patterns in your emotional responses to crises and work on strategies to address them.",
  "Create a list of resources (books, websites, hotlines) that can provide support during crises.",
