...
export const selfCare: BehavioralActivities[] = [
  {
    ...
    introduction:
      "Aromatherapy baths are a relaxing way to soothe your mind and body. This self-care activity allows you to create a personalized bath soak using essential oils and natural ingredients.",
    description:
  ...
  },
  {
    ...
    introduction:
      "Taking a break from screens can help reduce stress, improve sleep quality, and increase mindfulness. A digital detox gives you space to reconnect with yourself and the world around you.",
    description:
    ...
    conclusion:
      "A digital detox allows you to reconnect with the present moment, reduce stress, and improve your focus and overall mental health.",
  },
  {
    title: "Create a Vision Board",
    introduction:
      "Creating a vision board is a powerful self-care activity that helps you visualize your goals, dreams, and aspirations.",
    description:
    ...
    conclusion:
      "A vision board is a creative and powerful tool for clarifying your goals, manifesting dreams, and staying motivated to achieve your personal aspirations.",
  },
  {
    title: "Aromatic Tea Ceremony",
    introduction:
      "Aromatic tea ceremonies involve the mindful process of brewing and savoring different herbal teas, creating a tranquil and introspective moment.",
    description:
    ...
    conclusion:
      "The aromatic tea ceremony is a grounding practice that enhances mindfulness and provides a serene break from the stresses of the day.",
  },
  {
    title: "DIY Healing Facial Mask",
    introduction:
      "Homemade facial masks provide natural, nourishing care for your skin and offer a chance to practice self-love while indulging in a relaxing beauty routine.",
    description:
    ...
    conclusion:
      "A DIY healing facial mask nourishes the skin and offers a peaceful, pampering moment of self-care.",
  },
  {
    title: "DIY Candle Making",
    introduction:
      "Creating your own candles is a fun and creative way to relax, while crafting personalized scents that can elevate the ambiance of your space.",
    description:
    ...
    conclusion:
      "DIY candle making is a satisfying and creative form of self-care that leaves you with a beautiful, custom-made candle to enjoy during your self-care routine.",
  },
  {
    title: "Creating a Personalized Playlist for Emotional Release",
    introduction:
      "Music has a profound impact on emotional health. Curating a playlist specifically designed to evoke and release your emotions can be incredibly therapeutic.",
    description:
    ...
    conclusion:
      "A personalized playlist can serve as an emotional release mechanism, allowing you to process and reflect on your emotions in a healthy way.",
  },
  {
    title: "Floating Meditation (Sensory Deprivation)",
    introduction:
      "Floating meditation is practiced in a sensory deprivation tank, where you float effortlessly in warm saltwater, free from external stimuli.",
    description:
    ...
    conclusion:
      "Floating meditation offers a unique and profound way to reach a deep state of relaxation and mental clarity.",
  },
];
