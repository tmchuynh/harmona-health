export const dealingWithStressPrompts = [
  {
    ...
    ideas: [
      "Reflect on the specific situations, tasks, or people that trigger your stress.",
  ...
  {
    prompt:
      "How does stress manifest in my body, and what physical techniques can I use to release it?",
    ideas: [
      "Pay attention to how stress shows up in your body (e.g., tight shoulders, clenched jaw, shallow breathing).",
  ...
  {
    prompt:
      "What are the underlying thoughts or beliefs contributing to my stress, and how can I challenge them?",
    ideas: [
      "Examine your thought patterns when you feel stressed. Are there any negative or irrational beliefs that intensify your stress?",
  ...
  {
    prompt:
      "How can I set healthy boundaries to reduce stress in my relationships and work?",
    ideas: [
  ...
  {
    prompt:
      "When I’m feeling stressed, what grounding techniques can I use to bring myself back to the present moment?",
    ideas: [
      "Explore grounding techniques such as deep breathing, body scanning, or focusing on your senses.",
  ...
  {
    prompt:
      "How does my stress affect the people around me, and how can I communicate my needs to them more effectively?",
    ideas: [
      "Reflect on how your stress may impact your relationships with family, friends, or coworkers.",
  ...
  {
    prompt:
      "How can I prioritize rest and relaxation to prevent burnout from stress?",
    ideas: [
      "Consider how your current work or personal commitments may be leading to stress and potential burnout.",
  ...
  {
    prompt:
      "What small moments of joy can I incorporate into my day to counterbalance stress?",
    ideas: [
      "Think about activities or experiences that bring you happiness, even in small doses, such as listening to music, chatting with a friend, or enjoying a cup of tea.",
  ...
  {
    prompt:
      "How can I practice mindfulness in everyday tasks to reduce stress and increase presence?",
    ideas: [
      "Consider daily tasks like eating, walking, or cleaning. How can you engage more mindfully in these activities to reduce stress?",
  ...
  },
  {
    ...
    ideas: [
      "Identify the people, groups, or resources you can lean on when stress becomes overwhelming, such as friends, family, or a therapist.",
  ...
  {
    prompt:
      "What can I learn from my past experiences with stress that can help me cope better in the future?",
    ideas: [
