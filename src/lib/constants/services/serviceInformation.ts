...
export const serviceInformation: ServiceInformation[] = [
  {
    ...
    keypoints: [
      ...
      "Includes optional coaching and therapy support",
    ],
    outcomes: [
      "Improved physical health and energy levels",
      "Greater mental clarity and emotional balance",
      "Consistent healthy habits tailored to you",
    ],
    goals: [
  ...
  },
  {
    ...
    keypoints: [
      "Custom meal plans",
      "Monthly check-ins",
      "Live support and custom recipes",
    ],
    outcomes: [
    ...
    goals: [
      "Provide personalized meal guidance",
  ...
  },
  {
    ...
    keypoints: [
      ...
      "Lab testing and personalized protocols",
    ],
    outcomes: [
      "Improved digestive health",
      "Reduced gut-related symptoms",
      "Enhanced overall well-being",
    ],
    goals: [
      "Identify and address digestive issues",
  ...
  },
  {
    ...
    keypoints: [
      ...
      "Full supplement regimen and discounts",
    ],
    outcomes: [
      "Optimized supplement intake",
  ...
  },
  {
    ...
    keypoints: [
      ...
      "Daily accountability and custom workouts",
    ],
    outcomes: [
  ...
  },
  {
    ...
    keypoints: [
      ...
      "Unlimited access and 1-on-1 guidance",
    ],
    outcomes: [
  ...
  },
  {
    ...
    keypoints: [
      ...
      "Daily meditation challenges with 1-on-1 support",
    ],
    outcomes: [
  ...
  },
  {
    ...
    keypoints: [
      ...
      "1-on-1 neurocoaching and cognitive tech integration",
    ],
    outcomes: [
  ...
  },
  {
    ...
    keypoints: [
      ...
      "Weekly therapy and crisis support line",
    ],
    outcomes: [
    ...
    goals: [
      "Provide personalized therapy support",
  ...
  },
  {
    ...
    keypoints: [
      "Anxiety workbook and mindfulness routine",
      "Weekly journaling prompts and group support sessions",
      "1-on-1 coaching and nervous system regulation practices",
    ],
    outcomes: [
    ...
    goals: [
      "Support individuals with high-functioning anxiety",
  ...
  },
  {
    ...
    keypoints: [
      ...
      "Non-medical, lifestyle-first approach",
    ],
    outcomes: [
      "Improved daily structure and consistency",
      "Reduced task overwhelm and procrastination",
      "Increased self-compassion and productivity",
    ],
    goals: [
  ...
  },
  {
    ...
    keypoints: [
      ...
      "1-on-1 somatic coaching and custom regulation routine",
    ],
    outcomes: [
      "Improved emotional resilience",
  ...
  },
  {
    ...
    keypoints: [
      "EQ assessments and daily mood tracking",
      "Bi-weekly EQ coaching and relationship skills development",
      "Deep-dive emotional rewiring and immersive coaching",
    ],
    outcomes: [
  ...
  },
  {
    ...
    keypoints: [
      ...
      "Custom curriculum and 1-on-1 coaching for team members",
    ],
    outcomes: [
  ...
  },
  {
    ...
    keypoints: [
      ...
      "Custom wellness plans for teams and HR reporting dashboard",
    ],
    outcomes: [
  ...
  },
  {
    ...
    keypoints: [
      ...
      "Full executive wellness program and concierge support",
    ],
    outcomes: [
      "Improved executive performance",
      "Enhanced leadership well-being",
  ...
  },
  {
    ...
    keypoints: [
      ...
      "Custom digital wellness coaching and weekly tracking",
    ],
    outcomes: [
