  ...
  return (
    <ToolProvider value={{ tool, toolKit, toolKitID, toolInformation }}>
      <div className="mx-auto pt-3 md:pt-5 lg:pt-9 w-10/12 md:w-11/12">
        ...
        <p>
          <strong></strong> Within these collections, you will find practices
          that vary in difficulty — some may feel beginner-friendly, others may
          feel more intermediate or advanced depending on where you are on your
          personal journey. We want to remind you that healing, growth, and
          emotional mastery are not about rushing or "doing it all." They are
          about meeting yourself where you are, with compassion, patience, and
          respect for your current needs. While we wholeheartedly encourage you
          to gently stretch your comfort zone and explore new techniques that
          may support deeper healing, we also strongly encourage you to honor
          your natural pace, respect your own timing, and recognize that
          starting exactly where you are is powerful and enough.
        </p>
        <p>
