  ...
  return (
    <div className="relative px-6 lg:px-0 py-24 sm:py-32 overflow-hidden lg:overflow-visible isolate">
      <div className="-z-10 absolute inset-0 overflow-hidden">
        <svg
          aria-hidden="true"
          className="top-0 left-[max(50%,25rem)] absolute w-[128rem] h-[64rem] -translate-x-1/2 [mask-image:radial-gradient(64rem_64rem_at_top,white,transparent)] stroke-gray-200"
        >
          <defs>
            <pattern
              x="50%"
